...
CREATE UNIQUE INDEX IDX_UN_AUTHORITY ON CAR_RENTAL.AUTHORITY (USERNAME, AUTHORITY);
...
(
    ...
    CONSTRAINT FK_USER_DETAILS_AUTHORITY FOREIGN KEY (USERNAME) REFERENCES CAR_RENTAL.AUTHORITY (USERNAME)
);

CREATE UNIQUE INDEX IDX_UN_USER_DETAILS_EMAIL ON CAR_RENTAL.USER_DETAILS (EMAIL);
CREATE UNIQUE INDEX IDX_UN_USER_DETAILS_USER_NAME ON CAR_RENTAL.USER_DETAILS (USERNAME);
...
CREATE INDEX IDX_CAR_1 ON CAR_RENTAL.CAR_MODEL (BRAND_NAME, CAR_MODEL, BODY_TYPE, TRANSMISSION);
...
(
    ...
    CONSTRAINT FK_ORDER_USER_DETAILS FOREIGN KEY (USER_ID) REFERENCES CAR_RENTAL.USER_DETAILS (ID),
...
(
    ...
    CONSTRAINT FK_REPAIR_INVOICE_USER_DETAILS_CL FOREIGN KEY (CLIENT_ID) REFERENCES CAR_RENTAL.USER_DETAILS (ID),
    CONSTRAINT FK_REPAIR_INVOICE_USER_DETAILS_ADM FOREIGN KEY (ADMIN_ID) REFERENCES CAR_RENTAL.USER_DETAILS (ID)
);

...
(
    ...
    CONSTRAINT FK_REPAIR_INVOICE_USER_DETAILS_US FOREIGN KEY (CLIENT_ID) REFERENCES CAR_RENTAL.USER (ID),
...
CREATE INDEX IDX_REPAIR_INVOICE_USER_ID ON CAR_RENTAL.REPAIR_INVOICE (CLIENT_ID);
